...
set(MSG_I_FLAGS "-Itest_pub_sub:/home/team5/catkin_ws/src/ros_tutorials/test_pub_sub/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/team5/catkin_ws/src/ros_tutorials/test_pub_sub/msg/test_custom_msg.msg" NAME_WE)
add_custom_target(_test_pub_sub_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test_pub_sub" "/home/team5/catkin_ws/src/ros_tutorials/test_pub_sub/msg/test_custom_msg.msg" ""
)
...
_generate_msg_cpp(test_pub_sub
  "/home/team5/catkin_ws/src/ros_tutorials/test_pub_sub/msg/test_custom_msg.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test_pub_sub)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test_pub_sub\")")
  # install generated code
  install(
